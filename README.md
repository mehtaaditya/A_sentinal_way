...
## Services used: Azure Sentinel, Azure Arc, Azure Monitor Agent, AWS cloudformation, AWS Cloudtrail, AWS EC2 instances, Log analytics, Azure Logic Apps, Azure Lighthouse, Entra ID
